  ...
  return (
    <div className="readme-container">
      ...
      <div className="readme-content">
        ...
        <p className="readme-paragraph">
          2학기 공통 프로젝트에서 <u>트랙 우관 / 프론트엔드</u>를 희망합니다. 하지만 백엔드도 기회가 된다면 하고 싶습니다.
        ...
        <p className="readme-paragraph">
          ...
          친해지신 분과 <u>함께 고민하고 소통할 수 있는 팀</u>을 원하며, 저 역시 함께 궁금해하고 도와줄 수 있는 팀원이 되고 싶습니다. 🤝
        </p>

        <p className="readme-paragraph">
          팀 내에서는 주로 원활한 의사 소통을 위해 <u>노션을 통한 회의 내용 기록 및 팀 서포트 역할</u>을 해왔습니다. 📝
        </p>
